...
if args.num_classes == 10:
    ...
    # Use UCF101 for 100 classes, you may need to adjust the path and other parameters
    train_set = UCF101(root='./data/UCF101', split='train', frames_per_clip=16, step_between_clips=1, transform=transform)
    test_set = UCF101(root='./data/UCF101', split='test', frames_per_clip=16, step_between_clips=1, transform=transform)
# Modify transformations for UCF101 (you may need to adjust these based on your specific requirements)
